...
def login_clicked(e):
    ...
    if result and current_password == result[0]:
        ...
        text += '\nYou would now be directed to your Kuber account on pressing OK button.'
...
def show_register_info(username, balance):
    ...
    text += ' \n You can now login to continue using Kuber Trading Platform.'
...
login_text = """
            Welcome to the Kuber Trading Application, market investments are subject to market risk.
            Please Login if you already have an account. Else, start by registering with a username and a starting balance. 
            We hope you have a great time trading and investing. (App still in deveploment).
